...
namespace SW_PISSource
{
    ...
    public class SW_PISSource : System.Web.Services.WebService
    {
        ...
        [WebMethod]
        public string LogPISInfo(long alng_visitId, string astr_message , long alng_value, string astr_value)
        {
            DataTable ldtb_Result = new DataTable();// ' la tabla que obtiene el resultado
            OleDbDataAdapter iAdapt_comand = new OleDbDataAdapter();
            OleDbCommand iolecmd_comand = new OleDbCommand();
            ...
            iolecmd_comand.Parameters.Add("intValue", OleDbType.Numeric);
            iolecmd_comand.Parameters.Add("strValue", OleDbType.VarChar);
            ...
            iolecmd_comand.Parameters["intValue"].Value = alng_value;
            iolecmd_comand.Parameters["strValue"].Value = astr_value;
